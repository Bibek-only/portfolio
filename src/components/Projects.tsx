        ...
        <div className="">
          <div className="mt-8">
            ...
            <div className="flex justify-center items-center mt-4 gap-4">
              <button ref={keenSliderPrev} className="px-4 py-2  rounded-md">
                Prev
              </button>
              ...
              /
              <span ref={keenSliderCount} className="text-lg font-bold">
                3
              </span>
              <button ref={keenSliderNext} className="px-4 py-2  rounded-md">
                Next
              </button>
            </div>
          </div>
  ...
  return (
    <div className="keen-slider__slide opacity-40 transition-opacity duration-500 px-2">
      <blockquote className="rounded-lg   shadow-xs p-2 bg-[oklch(84.133%_0.065_90.856)] dark:bg-[oklch(25.33%_0.016_252.42)]">
        ...
        <p className="mt-4 ">
          "This is an amazing product! It changed my life!"
        </p>
      </blockquote>
    </div>
  );
